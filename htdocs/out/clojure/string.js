...
{
var G__4384 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__4385 = (limit__$1 - 1);
var G__4386 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__4384;
limit__$1 = G__4385;
parts = G__4386;
continue;
...
var temp__3971__auto___4388 = cljs.core._lookup.call(null,cmap,ch,null);
if(cljs.core.truth_(temp__3971__auto___4388))
{var replacement_4389 = temp__3971__auto___4388;
buffer.append([cljs.core.str(replacement_4389)].join(''));
} else
{buffer.append(ch);
}
{
...
var G__4391__delegate = function (m){
...
return G__4391__delegate.call(this, m);
};
G__4391.cljs$lang$maxFixedArity = 0;
G__4391.cljs$lang$applyTo = (function (arglist__4392){
var m = cljs.core.seq(arglist__4392);;
return G__4391__delegate(m);
});
